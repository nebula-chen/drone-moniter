...
type HandleGetMissionBySubIdLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewHandleGetMissionBySubIdLogic(ctx context.Context, svcCtx *svc.ServiceContext) *HandleGetMissionBySubIdLogic {
	return &HandleGetMissionBySubIdLogic{
...
func (l *HandleGetMissionBySubIdLogic) HandleGetMissionBySubId(req *types.GetMissionBySubIdReq) (*types.GetMissionBySubIdResp, error) {
	...
	var result types.GetMissionBySubIdResp
